          ...
          DataTable(
            ...
            rows: [
              DataRow(
                  ...
                  cells: [
                    DataCell(Text('Dulat', style: TextStyle(fontSize: 18),)),
              ...
              DataRow(
                  ...
                  cells: [
                    DataCell(Text('Didar', style: TextStyle(fontSize: 18),)),
              ...
              DataRow(
                  ...
                  cells: [
                    DataCell(Text('Magzhan', style: TextStyle(fontSize: 18),)),
              ...
              DataRow(
                  ...
                  cells: [
                    DataCell(Text('Sultan', style: TextStyle(fontSize: 18),)),
                    DataCell(Text('1', style: TextStyle(fontSize: 18),)),
                    DataCell(Text('ONLINE',
                        style: TextStyle(
                            color: Colors.white,
